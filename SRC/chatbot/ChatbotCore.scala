...
object ChatbotCore: // ChatbotCore contains the main chatbot logic
  ...
  def handleUserInput(
    ...
    // This is the important memory connection.
    // After every response, we save the user input, bot response, detected intent,
    // and updated state inside ConversationTracker.
    val finalState =
